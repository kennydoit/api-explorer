    ...
    "alpha_vantage": {
        ...
        "functions": {
            "NEWS_SENTIMENT": {
                ...
                "optional": ["tickers", "topics", "time_from", "time_to", "sort", "limit", "datatype"],
                "defaults": {
                    "sort": "LATEST",
                    "limit": 50,
                    "datatype": "json"
...
if __name__ == "__main__":
    # Update topics for NEWS_SENTIMENT
    update_current_values("alpha_vantage", "NEWS_SENTIMENT", 
                         topics="technology,retail_wholesale,real_estate",
                         tickers="NVDA,MSFT,GOOGL")
    
    # Build URL
    api_key = api_key
    url = build_url("alpha_vantage", "NEWS_SENTIMENT", api_key)
    print(f"Generated URL: {url}")
    
    # Override parameters on-the-fly
    url_override = build_url("alpha_vantage", "NEWS_SENTIMENT", api_key, 
                           limit=200, sort="RELEVANCE")
    print(f"URL with overrides: {url_override}")
